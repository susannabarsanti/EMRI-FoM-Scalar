...
if __name__ == "__main__":
    ...
    #folders = glob.glob(f"{source_f}/M*/")   #m1*/
    folders = [source_f]
    print(f"Found {len(folders)} files for source.")
    for i,fold in enumerate(folders):
        inference_dict = {} #put it here so that I have 1 inference.h per binary
        ...
        print("fold = ", fold)
        out_path = os.path.join(fold, "inference.h5")
        ...
        print(f"SNR data saved to {out_path}/inference.h5")